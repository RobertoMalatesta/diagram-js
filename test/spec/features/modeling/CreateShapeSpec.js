...
describe('features/modeling - create shape', function() {
  ...
  describe('attachment basics', function() {
    ...
    it('should have a host', inject(function(elementRegistry) {
  ...
  describe('multiple attachers', function () {
    ...
    it('should only have one attacher on remove', inject(function(modeling) {
      ...
      modeling.removeShape(childShape3);

      // then
      expect(childShape.attachers).to.have.length(1);

      expect(childShape.attachers).to.include(childShape4);
    }));
    ...
    it('should have 3 attachers on remove UNDO', inject(function(commandStack, modeling) {
      ...
      modeling.removeShape(childShape4);
      ...
      // then
      expect(childShape.attachers).to.have.length(3);

      expect(childShape.attachers).to.eql([ childShape2, childShape3, childShape4 ]);
    }));
